...
- [`docs/nine-fjords/DESIGN.md`](docs/nine-fjords/DESIGN.md) — Nine Fjords, a daily-turn
  empire game of Norse jarls raiding each other by longship (approved, being
  built), with the model that sized its economy.
